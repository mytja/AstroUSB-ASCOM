...
//
// ASCOM Switch driver for mytjaAstroUSB
//
...
namespace ASCOM.mytjaAstroUSB.Switch
{
    ...
    //
    // Your driver's DeviceID is ASCOM.mytjaAstroUSB.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.mytjaAstroUSB.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _mytjaAstroUSB from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("f6635137-e28b-4107-9e65-33bbb42662f0")]
    [ProgId("ASCOM.mytjaAstroUSB.Switch")]
    [ServedClassName("ASCOM Switch Driver for mytjaAstroUSB")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="mytjaAstroUSB"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "mytjaAstroUSB.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
